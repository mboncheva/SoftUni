namespace MyWebServer.GameStoreApplication.Common
{
    ...
    {
        public const string InvalidMinLegnthErrorMessage = "{0} must be at least {1} symbols.";
        public const string InvalidMaxLegnthErrorMessage = "{0} cannot be more than {1} symbols.";
