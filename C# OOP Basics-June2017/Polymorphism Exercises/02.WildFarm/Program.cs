...
public class StartUp
{
    public static void Main(string[] args)
    {
        ...
        while (true)
        {
            ...
            {
                currentFood = new Meet(quantiy);
            }

            switch (animalType)
            {
                case "Mouse":
                    Animals mouse = new Mouse(animalType, animalName, animalWeight, animalLivingRegion);
                    mouse.MakeSound();
                ...
                case "Cat":
                    Animals cat = new Cat(animalType, animalName, animalWeight, animalLivingRegion, catBreed);
                    cat.MakeSound();
                    cat.Eat(currentFood);
                ...
                case "Tiger":
                    Animals tiger = new Tiger(animalType, animalName, animalWeight, animalLivingRegion);
                    tiger.MakeSound();
                ...
                case "Zebra":
                    Animals zebra = new Zebra(animalType, animalName, animalWeight, animalLivingRegion);
                    zebra.MakeSound();
